  ...
  return (
    <div className="glass-surface rounded-3xl border-slate-200/70 p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className={`flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br ${accentMap[accent] || accentMap.blue} text-white shadow-lg shadow-slate-200`}>
